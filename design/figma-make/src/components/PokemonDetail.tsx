        ...
        <div className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-3 shadow-2xl border-4 border-gray-900">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-slate-800 rounded-2xl overflow-hidden relative border-2 border-cyan-500/30">
            ...
            <div className="bg-gradient-to-r from-orange-600 to-red-600 p-4 relative overflow-hidden">
              ...
              <button
                onClick={onClose}
                className="absolute top-3 right-3 w-8 h-8 bg-white/20 hover:bg-white/30 rounded-lg flex items-center justify-center transition-colors border border-white/30 z-10"
              >
            ...
            <div className="p-4 space-y-3 overflow-y-auto max-h-[calc(90vh-250px)] custom-scrollbar">
              ...
              <div className="bg-gradient-to-br from-slate-800/80 to-slate-700/80 rounded-xl p-3 border border-cyan-500/30">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-cyan-400 tracking-wider">DESCRIPTION</span>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-orange-100 text-sm tracking-wider">VITALS</h3>
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-gradient-to-br from-red-900/40 to-red-800/40 rounded-lg p-2.5 border border-red-500/30">
                    <div className="flex items-center gap-1 mb-1">
                      ...
                      <span className="text-xs text-red-300 tracking-wide">HT</span>
                    </div>
                    <p className="text-white text-xs font-mono">{pokemon.height}</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/40 rounded-lg p-2.5 border border-blue-500/30">
                    <div className="flex items-center gap-1 mb-1">
                      ...
                      <span className="text-xs text-blue-300 tracking-wide">WT</span>
                    </div>
                    <p className="text-white text-xs font-mono">{pokemon.weight}</p>
                  </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-green-100 text-sm tracking-wider">BASE STATS</h3>
                </div>
                  ...
                  {[
                    ...
                    <div key={stat.name} className="bg-slate-800/50 rounded-lg p-2 border border-slate-700/50">
                      <div className="flex items-center gap-2">
                        <span className="text-xs text-slate-400 w-10 font-mono">{stat.name}</span>
